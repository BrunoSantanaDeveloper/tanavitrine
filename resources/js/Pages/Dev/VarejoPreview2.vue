...
import StoreCard from '@/Components/StoreCardPreview2.vue'
...
function handleBackToTopVisibility() {
  ...
  // Small threshold avoids flicker on tiny scroll updates.
  if (delta > 6) {
...
<template>
  ...
  <button
    ...
    type="button"
    class="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 inline-flex items-center gap-2 rounded-full border border-green-700 bg-green-600 px-4 py-2.5 shadow-lg transition hover:bg-green-700 hover:shadow-xl"
