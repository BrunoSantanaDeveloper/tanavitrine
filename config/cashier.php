...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can define the subscription plans that are available in your
    | application. Each plan should have a unique key, a name, a price ID
    | from Stripe, and a price amount.
    |
    */
